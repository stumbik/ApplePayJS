...
define('PRODUCTION_CERTIFICATE_KEY', '../certificates/ApplePay.key.pem');
define('PRODUCTION_CERTIFICATE_PATH', '../certificates/ApplePay.crt.pem');
...
define('PRODUCTION_CURRENCYCODE', 'CZK');	// https://en.wikipedia.org/wiki/ISO_4217
define('PRODUCTION_COUNTRYCODE', 'CZ');		// https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
define('PRODUCTION_DISPLAYNAME', 'Footshop DEMO');
